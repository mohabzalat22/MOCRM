...
interface TemplateAddTaskFormProps {
    templateId: number;
...
export function TemplateAddTaskForm({
    templateId,
    templateTasks = EMPTY_TASKS,
    onSuccess,
}: TemplateAddTaskFormProps) {
            ...
            >
                ...
                <div className="flex items-center justify-between pt-2">
                    <div className="group flex items-center gap-3 rounded-md px-3 py-1.5 transition-colors hover:bg-muted/50">
                        ...
                        />
                        <Label
                            htmlFor="is_milestone_add_template"
